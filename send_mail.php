...
try {
    ...
    //Recipients
    $mail->setFrom('achupradeep10012025@gmail.com', 'Mailer');         //Set the sender of the message (your email address)
    $mail->addAddress('achupradeep10012025@gmail.com', 'Joe User');     //Add a recipient (your bae's email address)
